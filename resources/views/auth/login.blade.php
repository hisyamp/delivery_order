		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sketchy-1/14.png">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<h1 class="text-dark mb-3">Delivery Order</h1>
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{url('/postlogin')}}" method="POST">
							...
							<div class="text-center mb-10">
								...
								<div class="text-gray-400 fw-bold fs-4">Belum punya akun?
									<a href="#" class="link-primary fw-bolder" data-bs-toggle="modal" data-bs-target="#modal-regis">Daftar Sekarang</a></div>
									<!--end::Link-->
									<!--begin::Title-->
							...
							<div class="fv-row mb-10">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid" type="text" name="username" autocomplete="off"   placeholder="Masukkan Username"/>
								<!--end::Input-->
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
